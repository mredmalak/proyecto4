      ...
      <>
        ...
        {this.state.recetaCreated === false && (
          <form onSubmit={this.handleSubmit}>
            ...
            <input name="name_receta" onChange={this.handleChange} />
            <label>Procceso de cocion</label>
            <input name="process_receta" onChange={this.handleChange} />
        ...
        {this.state.recetaCreated === true && (
          <>
            <h2>
              Tu receta de {this.state.receta.name_receta} de{' '}
              {this.state.receta.porciones_receta} porciones fue creada. Ahora
            ...
            {this.state.numeroDeIngredientes > 0 &&
              this.state.ingredientesDeReceta.map((ingrediente) => (
                <>
                  ...
                  <p>Cantidad: {ingrediente.amount_ingrediente}</p>
                </>
              ))}
